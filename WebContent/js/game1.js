...
var elapsedTime=0;
var background = {
		x:0, y:0, image:'img/hihi.png', swidth:1536, sheight:1536, dx:0, dy:0, dwidth:canvas.width, dheight:canvas.height/2};
...
function updateHorse(){
    ...
    /*	var ranDx=Math.random();
    	...
    	if((horse.mini.arc_x>miniMap.appearance.rect_x-30 && horse.mini.arc_x<=miniMap.appearance.rect_x+miniMap.appearance.rect_width+41)
    		...
    		if(horse.mini.loc==3 || horse.mini.loc==0){		// 좌측 상단(오른쪽 직진 코스)진입
